      ...
      <div className='ContenedorRest '>
        <form className="row g-3">
                ...
                <div className="col-md-6">
                    <label for="inputAddress" class="form-label" >Nombre del Establecimiento</label>
                    <input type="text" class="form-control" id="inputEmail4" placeholder="Ingrese el nombre del establecimiento"/>
                </div>
                ...
                <div className="col-md-6">
                    <label for="inputAddress" class="form-label" >Teléfono del establecimiento</label>
                    <input type="text" class="form-control" id="inputEmail4" placeholder="809-555-5555"/>
                </div>

                <div className="col-md-6">
                    <label for="inputAddress2" class="form-label">Dirección del establecimiento</label>
                ...
                <div className="col-md-3  ">
                    ...
                    <input type="text" class="form-control " id="inputAddress2" placeholder="@instagram"/>
                </div>
                <div className="col-md-3">
                    <label htmlFor="">Facebook del establecimiento</label>
                    <input type="text" class="form-control " id="inputAddress2" placeholder="@facebook"/>
                </div>
                <div className="col-md-7">
                    <label htmlFor="">Google Maps del Establecimiento</label>
                    <input type="text" class="form-control " id="inputAddress2" placeholder="https://maps.app.goo.gl/FkDLmARyyp6Vgg7U6"/>
                </div>
                <span></span>
                <div className="col-md-4">
                    <label htmlFor="">Horario de Apertura</label>
                    <input type="time" class="form-control " id="inputAddress2" placeholder=""/>
                </div>
                <div className="col-md-4">
